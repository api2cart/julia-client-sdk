...
**mail_class** | **String** | Mail class for the shipment (e.g., priority, express). | [optional] [default to nothing]
**ship_date** | **String** | Ship date. | [optional] [default to nothing]
...
**shipping_label_cost** | **Float64** | Cost of the shipping label. | [optional] [default to nothing]
**shipping_label_currency** | **String** | Currency code for the shipping label cost (3-letter ISO code). | [optional] [default to nothing]
**revenue_eligibility** | **Bool** | Revenue eligibility flag. | [optional] [default to nothing]
**ship_from_country** | **String** | Country code the shipment is sent from (2-letter ISO code). | [optional] [default to nothing]
**ship_to_country** | **String** | Country code the shipment is sent to (2-letter ISO code). | [optional] [default to nothing]
**incoterm** | **String** | International commercial term for the shipment (e.g., DAP, DDP). | [optional] [default to nothing]
**duty_amount** | **Float64** | Duty amount for international shipment. | [optional] [default to nothing]
**duty_currency** | **String** | Currency code for the duty amount (3-letter ISO code). | [optional] [default to nothing]
