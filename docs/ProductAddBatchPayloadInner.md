...
**asin** | **String** |  | [optional] [default to nothing]
...
**advanced_prices** | [**Vector{ProductAddBatchPayloadInnerAdvancedPricesInner}**](ProductAddBatchPayloadInnerAdvancedPricesInner.md) |  | [optional] [default to nothing]
**fixed_cost_shipping_price** | **Float64** |  | [optional] [default to nothing]
**buyitnow_price** | **Float64** |  | [optional] [default to nothing]
**reserve_price** | **Float64** |  | [optional] [default to nothing]
**best_offer** | **Float64** |  | [optional] [default to nothing]
**quantity** | **Float64** |  | [optional] [default to nothing]
**manage_stock** | **Bool** |  | [optional] [default to nothing]
**product_type** | **String** |  | [optional] [default to nothing]
**marketplace_item_properties** | **Any** |  | [optional] [default to nothing]
**specifics** | **Any** |  | [optional] [default to nothing]
...
**listing_type** | **String** |  | [optional] [default to nothing]
**listing_duration** | **String** |  | [optional] [default to nothing]
