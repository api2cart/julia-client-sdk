...
------------ | ------------- | ------------- | -------------
**cart_id** | **String** | Integration identifier | [default to nothing]
...
**store_key** | **String** | If a bridge connector is already installed on the store, you MUST pass here the store key it generated during installation, to connect via the bridge-based integration. Omit it only when connecting via an API-based integration, which uses API credentials instead. | [optional] [default to nothing]
**label** | **String** | Defines alternative text that has to be attached to the picture | [optional] [default to nothing]
**custom_label** | **String** | Defines a custom label for the store in the app | [optional] [default to nothing]
...
**nopcommerce_token** | **String** | Access token authorizing the app to access resources on behalf of a user | [optional] [default to nothing]
**nopcommerce_secret** | **String** | nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it. | [optional] [default to nothing]
...
**walmart_refresh_token** | **String** | Walmart refresh token received by a Solution Provider application through the Walmart App Store authorization. When it is set, walmart_client_id and walmart_client_secret are the credentials of that application, not of the seller. Must be used together with walmart_seller_id and is supported only for walmart_region &#x3D; &#39;us&#39; | [optional] [default to nothing]
**walmart_seller_id** | **String** | Walmart seller id the refresh token was issued for, sent as the WM_PARTNER.ID header. Must be used together with walmart_refresh_token and is supported only for walmart_region &#x3D; &#39;us&#39; | [optional] [default to nothing]
...
**mirakl_api_key** | **String** | Mirakl API Key | [optional] [default to nothing]
...
**jumpseller_client_id** | **String** | Jumpseller OAuth2 Client ID | [optional] [default to nothing]
**jumpseller_client_secret** | **String** | Jumpseller OAuth2 Client Secret | [optional] [default to nothing]
**jumpseller_refresh_token** | **String** | Jumpseller OAuth2 refresh token | [optional] [default to nothing]
**jumpseller_login** | **String** | Jumpseller API login | [optional] [default to nothing]
**jumpseller_authtoken** | **String** | Jumpseller API auth token | [optional] [default to nothing]
