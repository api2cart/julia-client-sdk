...
**payload** | [**Vector{ProductAddBatchPayloadInner}**](ProductAddBatchPayloadInner.md) | Contains an array of product objects. The list of properties may vary depending on the specific platform. | [default to nothing]
