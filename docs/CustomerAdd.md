...
**is_tax_exempt** | **Bool** | Marks a customer as tax-exempt (B2B/wholesale). | [optional] [default to nothing]
**vendor_id** | **String** | Assigns vendor id to the customer | [optional] [default to nothing]
