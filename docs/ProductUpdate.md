...
**in_stock** | **Bool** | Set stock status. Effective only when manage_stock is false — when stock is managed, the status is derived from quantity automatically and this parameter is ignored. | [optional] [default to nothing]
...
**brand_name** | **String** | Retrieves brands specified by brand name | [optional] [default to nothing]
...
**quantity** | **Float64** | Defines new product&#39;s quantity. Effective only when manage_stock is true — otherwise the value is ignored. To enable stock tracking and set a quantity in one call, pass manage_stock&#x3D;true together with quantity. | [optional] [default to nothing]
**reserve_quantity** | **Float64** | This parameter allows to reserve/unreserve product quantity. | [optional] [default to nothing]
**manage_stock** | **Bool** | Defines inventory tracking for product. When true, quantity sets the stock level and the stock status is derived from it; when false, quantity is ignored and in_stock sets the status directly. | [optional] [default to nothing]
**backorder_status** | **String** | Set backorder status | [optional] [default to nothing]
**increase_quantity** | **Float64** | Defines the incremental changes in product quantity. Effective only when manage_stock is true — otherwise the value is ignored. | [optional] [default to nothing]
**reduce_quantity** | **Float64** | Defines the decrement changes in product quantity. Effective only when manage_stock is true — otherwise the value is ignored. | [optional] [default to nothing]
...
**manufacturer_ids** | **String** | A comma-separated list of manufacturer IDs. Retrieve the IDs from the cart.info method. | [optional] [default to nothing]
**responsible_person_ids** | **String** | A comma-separated list of responsible person IDs. Retrieve the IDs from the cart.info method. | [optional] [default to nothing]
