...
function _oacinternal_basket_item_add(_api::BasketApi, customer_id::String, product_id::String; variant_id=nothing, quantity=nothing, store_id=nothing, idempotency_key=nothing, _mediaType=nothing)
...
"""
function basket_item_add(_api::BasketApi, customer_id::String, product_id::String; variant_id=nothing, quantity=nothing, store_id=nothing, idempotency_key=nothing, _mediaType=nothing)
    _ctx = _oacinternal_basket_item_add(_api, customer_id, product_id; variant_id=variant_id, quantity=quantity, store_id=store_id, idempotency_key=idempotency_key, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function basket_item_add(_api::BasketApi, response_stream::Channel, customer_id::String, product_id::String; variant_id=nothing, quantity=nothing, store_id=nothing, idempotency_key=nothing, _mediaType=nothing)
    _ctx = _oacinternal_basket_item_add(_api, customer_id, product_id; variant_id=variant_id, quantity=quantity, store_id=store_id, idempotency_key=idempotency_key, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
...
function _oacinternal_basket_live_shipping_service_create(_api::BasketApi, name::String, callback::String; store_id=nothing, idempotency_key=nothing, _mediaType=nothing)
...
"""
function basket_live_shipping_service_create(_api::BasketApi, name::String, callback::String; store_id=nothing, idempotency_key=nothing, _mediaType=nothing)
    _ctx = _oacinternal_basket_live_shipping_service_create(_api, name, callback; store_id=store_id, idempotency_key=idempotency_key, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx)
end

function basket_live_shipping_service_create(_api::BasketApi, response_stream::Channel, name::String, callback::String; store_id=nothing, idempotency_key=nothing, _mediaType=nothing)
    _ctx = _oacinternal_basket_live_shipping_service_create(_api, name, callback; store_id=store_id, idempotency_key=idempotency_key, _mediaType=_mediaType)
    return OpenAPI.Clients.exec(_ctx, response_stream)
end
