...
Base.@kwdef mutable struct Plugin <: OpenAPI.APIModel
    ...
    function Plugin(name, code, active, additional_fields, custom_fields, )
        OpenAPI.validate_property(Plugin, Symbol("name"), name)
        OpenAPI.validate_property(Plugin, Symbol("code"), code)
        ...
        return new(name, code, active, additional_fields, custom_fields, )
    end
end # type Plugin

const _property_types_Plugin = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("code")=>"String", Symbol("active")=>"Bool", Symbol("additional_fields")=>"Any", Symbol("custom_fields")=>"Any", )
