...
"""
Base.@kwdef mutable struct WebhookUpdate <: OpenAPI.APIModel
    ...
    function WebhookUpdate(id, callback, label, fields, response_fields, active, lang_id, filtering_conditions, idempotency_key, )
        OpenAPI.validate_property(WebhookUpdate, Symbol("id"), id)
        OpenAPI.validate_property(WebhookUpdate, Symbol("callback"), callback)
        OpenAPI.validate_property(WebhookUpdate, Symbol("label"), label)
        OpenAPI.validate_property(WebhookUpdate, Symbol("fields"), fields)
        OpenAPI.validate_property(WebhookUpdate, Symbol("response_fields"), response_fields)
        OpenAPI.validate_property(WebhookUpdate, Symbol("active"), active)
        OpenAPI.validate_property(WebhookUpdate, Symbol("lang_id"), lang_id)
        OpenAPI.validate_property(WebhookUpdate, Symbol("filtering_conditions"), filtering_conditions)
        OpenAPI.validate_property(WebhookUpdate, Symbol("idempotency_key"), idempotency_key)
        return new(id, callback, label, fields, response_fields, active, lang_id, filtering_conditions, idempotency_key, )
    end
end # type WebhookUpdate

const _property_types_WebhookUpdate = Dict{Symbol,String}(Symbol("id")=>"String", Symbol("callback")=>"String", Symbol("label")=>"String", Symbol("fields")=>"String", Symbol("response_fields")=>"String", Symbol("active")=>"Bool", Symbol("lang_id")=>"String", Symbol("filtering_conditions")=>"ParamDefinitionFilteringConditionsFilterCondition", Symbol("idempotency_key")=>"String", )
OpenAPI.property_type(::Type{ WebhookUpdate }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_WebhookUpdate[name]))}

function check_required(o::WebhookUpdate)
    o.id === nothing && (return false)
    true
end

function OpenAPI.validate_property(::Type{ WebhookUpdate }, name::Symbol, val)
