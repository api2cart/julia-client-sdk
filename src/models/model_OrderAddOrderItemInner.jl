...
const _property_types_OrderAddOrderItemInner = Dict{Symbol,String}(Symbol("order_item_id")=>"String", Symbol("order_item_name")=>"String", Symbol("order_item_model")=>"String", Symbol("order_item_price")=>"Float64", Symbol("order_item_quantity")=>"Int64", Symbol("order_item_weight")=>"Float64", Symbol("order_item_variant_id")=>"String", Symbol("order_item_tax")=>"Float64", Symbol("order_item_price_includes_tax")=>"Bool", Symbol("order_item_parent")=>"Int64", Symbol("order_item_parent_option_name")=>"String", Symbol("order_item_allow_refund_items_separately")=>"Bool", Symbol("order_item_allow_ship_items_separately")=>"Bool", Symbol("order_item_option")=>"Vector{OrderAddOrderItemInnerOrderItemOptionInner}", Symbol("order_item_property")=>"Vector{OrderAddOrderItemInnerOrderItemPropertyInner}", )
