...
Base.@kwdef mutable struct OrderAdd <: OpenAPI.APIModel
    ...
    function OrderAdd(id, order_id, store_id, channel_id, order_status, send_notifications, send_admin_notifications, customer_email, bill_first_name, bill_last_name, bill_address_1, bill_city, bill_postcode, bill_state, bill_country, shipp_first_name, shipp_last_name, shipp_address_1, shipp_city, shipp_postcode, shipp_state, shipp_country, total_price, date, order_payment_method, transaction_id, order_shipping_method, currency, bill_address_2, bill_company, bill_phone, bill_fax, comment, admin_comment, admin_private_comment, customer_first_name, customer_last_name, customer_phone, customer_country, customer_birthday, customer_fax, shipp_address_2, shipp_company, shipp_phone, shipp_fax, date_modified, date_finished, subtotal_price, tax_price, prices_inc_tax, shipping_price, shipping_tax, carrier_id, warehouse_id, discount, coupon_discount, coupons, gift_certificate_discount, fulfillment_status, financial_status, total_paid, external_source, tags, inventory_behaviour, create_invoice, note_attributes, total_weight, clear_cache, origin, order_item, )
        ...
        return new(id, order_id, store_id, channel_id, order_status, send_notifications, send_admin_notifications, customer_email, bill_first_name, bill_last_name, bill_address_1, bill_city, bill_postcode, bill_state, bill_country, shipp_first_name, shipp_last_name, shipp_address_1, shipp_city, shipp_postcode, shipp_state, shipp_country, total_price, date, order_payment_method, transaction_id, order_shipping_method, currency, bill_address_2, bill_company, bill_phone, bill_fax, comment, admin_comment, admin_private_comment, customer_first_name, customer_last_name, customer_phone, customer_country, customer_birthday, customer_fax, shipp_address_2, shipp_company, shipp_phone, shipp_fax, date_modified, date_finished, subtotal_price, tax_price, prices_inc_tax, shipping_price, shipping_tax, carrier_id, warehouse_id, discount, coupon_discount, coupons, gift_certificate_discount, fulfillment_status, financial_status, total_paid, external_source, tags, inventory_behaviour, create_invoice, note_attributes, total_weight, clear_cache, origin, order_item, )
    end
end # type OrderAdd

const _property_types_OrderAdd = Dict{Symbol,String}(Symbol("id")=>"String", Symbol("order_id")=>"String", Symbol("store_id")=>"String", Symbol("channel_id")=>"String", Symbol("order_status")=>"String", Symbol("send_notifications")=>"Bool", Symbol("send_admin_notifications")=>"Bool", Symbol("customer_email")=>"String", Symbol("bill_first_name")=>"String", Symbol("bill_last_name")=>"String", Symbol("bill_address_1")=>"String", Symbol("bill_city")=>"String", Symbol("bill_postcode")=>"String", Symbol("bill_state")=>"String", Symbol("bill_country")=>"String", Symbol("shipp_first_name")=>"String", Symbol("shipp_last_name")=>"String", Symbol("shipp_address_1")=>"String", Symbol("shipp_city")=>"String", Symbol("shipp_postcode")=>"String", Symbol("shipp_state")=>"String", Symbol("shipp_country")=>"String", Symbol("total_price")=>"Float64", Symbol("date")=>"String", Symbol("order_payment_method")=>"String", Symbol("transaction_id")=>"String", Symbol("order_shipping_method")=>"String", Symbol("currency")=>"String", Symbol("bill_address_2")=>"String", Symbol("bill_company")=>"String", Symbol("bill_phone")=>"String", Symbol("bill_fax")=>"String", Symbol("comment")=>"String", Symbol("admin_comment")=>"String", Symbol("admin_private_comment")=>"String", Symbol("customer_first_name")=>"String", Symbol("customer_last_name")=>"String", Symbol("customer_phone")=>"String", Symbol("customer_country")=>"String", Symbol("customer_birthday")=>"String", Symbol("customer_fax")=>"String", Symbol("shipp_address_2")=>"String", Symbol("shipp_company")=>"String", Symbol("shipp_phone")=>"String", Symbol("shipp_fax")=>"String", Symbol("date_modified")=>"String", Symbol("date_finished")=>"String", Symbol("subtotal_price")=>"Float64", Symbol("tax_price")=>"Float64", Symbol("prices_inc_tax")=>"Bool", Symbol("shipping_price")=>"Float64", Symbol("shipping_tax")=>"Float64", Symbol("carrier_id")=>"String", Symbol("warehouse_id")=>"String", Symbol("discount")=>"Float64", Symbol("coupon_discount")=>"Float64", Symbol("coupons")=>"Vector{String}", Symbol("gift_certificate_discount")=>"Float64", Symbol("fulfillment_status")=>"String", Symbol("financial_status")=>"String", Symbol("total_paid")=>"Float64", Symbol("external_source")=>"String", Symbol("tags")=>"String", Symbol("inventory_behaviour")=>"String", Symbol("create_invoice")=>"Bool", Symbol("note_attributes")=>"Vector{OrderAddNoteAttributesInner}", Symbol("total_weight")=>"Int64", Symbol("clear_cache")=>"Bool", Symbol("origin")=>"String", Symbol("order_item")=>"Vector{OrderAddOrderItemInner}", )
