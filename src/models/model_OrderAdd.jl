...
@doc raw"""OrderAdd
    ...
    OrderAdd(;
        ...
        invoice_admin_comment=nothing,
        note_attributes=nothing,
        clear_cache=true,
        origin=nothing,
        fee_price=nothing,
        shipp_national_address=nothing,
        shipp_building_number=nothing,
        shipp_additional_number=nothing,
    ...
    - invoice_admin_comment::String : Specifies admin&#39;s order invoice comment
    ...
    - shipp_national_address::String : Specifies short national address code of a shipping address
    - shipp_building_number::String : Specifies building number of a shipping address
    - shipp_additional_number::String : Specifies additional number of a shipping address
...
Base.@kwdef mutable struct OrderAdd <: OpenAPI.APIModel
    ...
    invoice_admin_comment::Union{Nothing, String} = nothing
    ...
    shipp_national_address::Union{Nothing, String} = nothing
    shipp_building_number::Union{Nothing, String} = nothing
    shipp_additional_number::Union{Nothing, String} = nothing
    ...
    function OrderAdd(id, order_id, store_id, channel_id, order_status, fulfillment_status, financial_status, customer_email, customer_first_name, customer_last_name, customer_phone, customer_country, customer_birthday, customer_fax, is_guest, order_payment_method, transaction_id, currency, date, date_modified, date_finished, bill_first_name, bill_last_name, bill_address_1, bill_address_2, bill_city, bill_postcode, bill_state, bill_country, bill_company, bill_phone, bill_fax, shipp_first_name, shipp_last_name, shipp_address_1, shipp_address_2, shipp_city, shipp_postcode, shipp_state, shipp_country, shipp_company, shipp_phone, shipp_fax, subtotal_price, tax_price, total_price, total_paid, total_weight, prices_inc_tax, shipping_price, shipping_tax, discount, coupon_discount, gift_certificate_discount, order_shipping_method, carrier_id, warehouse_id, coupons, tags, comment, admin_comment, admin_private_comment, send_notifications, send_admin_notifications, external_source, inventory_behaviour, create_invoice, invoice_admin_comment, note_attributes, clear_cache, origin, fee_price, shipp_national_address, shipp_building_number, shipp_additional_number, idempotency_key, order_item, )
        ...
        OpenAPI.validate_property(OrderAdd, Symbol("invoice_admin_comment"), invoice_admin_comment)
        ...
        OpenAPI.validate_property(OrderAdd, Symbol("shipp_national_address"), shipp_national_address)
        OpenAPI.validate_property(OrderAdd, Symbol("shipp_building_number"), shipp_building_number)
        OpenAPI.validate_property(OrderAdd, Symbol("shipp_additional_number"), shipp_additional_number)
        OpenAPI.validate_property(OrderAdd, Symbol("idempotency_key"), idempotency_key)
