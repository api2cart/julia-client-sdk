...
Base.@kwdef mutable struct CartCouponAdd <: OpenAPI.APIModel
    ...
    function CartCouponAdd(code, action_type, action_apply_to, action_scope, action_amount, codes, name, date_start, date_end, usage_limit, usage_limit_per_customer, action_condition_entity, action_condition_key, action_condition_operator, action_condition_value, include_tax, store_id, free_cash_on_delivery, customer_id, idempotency_key, )
        ...
        OpenAPI.validate_property(CartCouponAdd, Symbol("idempotency_key"), idempotency_key)
        return new(code, action_type, action_apply_to, action_scope, action_amount, codes, name, date_start, date_end, usage_limit, usage_limit_per_customer, action_condition_entity, action_condition_key, action_condition_operator, action_condition_value, include_tax, store_id, free_cash_on_delivery, customer_id, idempotency_key, )
    end
end # type CartCouponAdd

const _property_types_CartCouponAdd = Dict{Symbol,String}(Symbol("code")=>"String", Symbol("action_type")=>"String", Symbol("action_apply_to")=>"String", Symbol("action_scope")=>"String", Symbol("action_amount")=>"Float64", Symbol("codes")=>"Vector{String}", Symbol("name")=>"String", Symbol("date_start")=>"String", Symbol("date_end")=>"String", Symbol("usage_limit")=>"Int64", Symbol("usage_limit_per_customer")=>"Int64", Symbol("action_condition_entity")=>"String", Symbol("action_condition_key")=>"String", Symbol("action_condition_operator")=>"String", Symbol("action_condition_value")=>"String", Symbol("include_tax")=>"Bool", Symbol("store_id")=>"String", Symbol("free_cash_on_delivery")=>"Bool", Symbol("customer_id")=>"String", Symbol("idempotency_key")=>"String", )
