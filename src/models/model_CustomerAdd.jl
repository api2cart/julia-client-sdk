...
Base.@kwdef mutable struct CustomerAdd <: OpenAPI.APIModel
    ...
    news_letter_subscription::Union{Nothing, Bool} = false
    ...
    function CustomerAdd(email, first_name, last_name, password, group, group_ids, created_time, modified_time, login, last_login, birth_day, status, news_letter_subscription, consents, gender, website, store_id, fax, company, phone, note, country, address, )
        ...
        return new(email, first_name, last_name, password, group, group_ids, created_time, modified_time, login, last_login, birth_day, status, news_letter_subscription, consents, gender, website, store_id, fax, company, phone, note, country, address, )
    end
end # type CustomerAdd

const _property_types_CustomerAdd = Dict{Symbol,String}(Symbol("email")=>"String", Symbol("first_name")=>"String", Symbol("last_name")=>"String", Symbol("password")=>"String", Symbol("group")=>"String", Symbol("group_ids")=>"String", Symbol("created_time")=>"String", Symbol("modified_time")=>"String", Symbol("login")=>"String", Symbol("last_login")=>"String", Symbol("birth_day")=>"String", Symbol("status")=>"String", Symbol("news_letter_subscription")=>"Bool", Symbol("consents")=>"Vector{CustomerAddConsentsInner}", Symbol("gender")=>"String", Symbol("website")=>"String", Symbol("store_id")=>"String", Symbol("fax")=>"String", Symbol("company")=>"String", Symbol("phone")=>"String", Symbol("note")=>"String", Symbol("country")=>"String", Symbol("address")=>"Vector{CustomerAddAddressInner}", )
