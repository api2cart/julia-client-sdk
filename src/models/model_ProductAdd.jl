...
Base.@kwdef mutable struct ProductAdd <: OpenAPI.APIModel
    ...
    function ProductAdd(name, model, description, price, sku, short_description, type, status, visible, category_id, categories_ids, product_class, product_type, is_virtual, downloadable, is_supply, available_for_view, available_for_sale, store_id, stores_ids, lang_id, old_price, special_price, wholesale_price, cost_price, fixed_cost_shipping_price, tier_prices, group_prices, buyitnow_price, reserve_price, measure_unit, unit_price, prices_inc_tax, retail_price, quantity, in_stock, manage_stock, warehouse_id, backorder_status, min_order_quantity, max_order_quantity, low_stock_threshold, weight, weight_unit, width, height, length, dimensions_unit, barcode, upc, ean, isbn, gtin, mpn, asin, product_reference, external_product_link, harmonized_system_code, country_of_origin, manufacturer, manufacturer_id, manufacturer_info, brand_name, image_url, image_name, additional_image_urls, files, size_chart, related_products_ids, up_sell_products_ids, cross_sell_products_ids, attribute_set_name, attribute_name, search_keywords, tags, materials, certifications, specifics, avail_from, sprice_create, sprice_modified, sprice_expire, created_at, auto_renew, when_made, meta_title, meta_keywords, meta_description, url, seo_url, tax_class_id, taxable, sales_tax, condition, condition_description, allow_display_condition, payment_methods, paypal_email, shipping_template_id, processing_profile_id, shipping_details, is_free_shipping, delivery_code, delivery_type, delivery_time, delivery_option_ids, package_details, logistic_info, listing_duration, listing_type, category_type, return_accepted, seller_profiles, auction_confidentiality_level, best_offer, production_partner_ids, marketplace_item_properties, clear_cache, viewed_count, ordered_count, vendor_id, shop_section_id, return_policy_id, personalization_details, personalization_questions, manufacturer_ids, responsible_person_ids, idempotency_key, )
        ...
        OpenAPI.validate_property(ProductAdd, Symbol("prices_inc_tax"), prices_inc_tax)
        OpenAPI.validate_property(ProductAdd, Symbol("retail_price"), retail_price)
        ...
        OpenAPI.validate_property(ProductAdd, Symbol("vendor_id"), vendor_id)
        ...
        OpenAPI.validate_property(ProductAdd, Symbol("personalization_questions"), personalization_questions)
        OpenAPI.validate_property(ProductAdd, Symbol("manufacturer_ids"), manufacturer_ids)
        OpenAPI.validate_property(ProductAdd, Symbol("responsible_person_ids"), responsible_person_ids)
...
function OpenAPI.validate_property(::Type{ ProductAdd }, name::Symbol, val)
    ...
    if name === Symbol("personalization_questions")
        OpenAPI.validate_param(name, "ProductAdd", :maxItems, val, 5)
        OpenAPI.validate_param(name, "ProductAdd", :minItems, val, 1)
    end
