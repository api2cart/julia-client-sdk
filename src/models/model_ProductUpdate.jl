...
Base.@kwdef mutable struct ProductUpdate <: OpenAPI.APIModel
    ...
    function ProductUpdate(id, model, old_price, price, special_price, sprice_create, sprice_expire, cost_price, fixed_cost_shipping_price, retail_price, quantity, available_for_view, weight, weight_unit, dimensions_unit, increase_quantity, reduce_quantity, warehouse_id, reserve_quantity, manage_stock, backorder_status, name, sku, visible, manufacturer, manufacturer_id, categories_ids, related_products_ids, up_sell_products_ids, cross_sell_products_ids, description, short_description, meta_title, meta_keywords, meta_description, store_id, lang_id, in_stock, status, seo_url, report_request_id, disable_report_cache, reindex, tags, clear_cache, gtin, upc, mpn, ean, isbn, taxable, product_class, height, length, width, harmonized_system_code, country_of_origin, search_keywords, barcode, is_virtual, is_free_shipping, reserve_price, buyitnow_price, avail_from, tax_class_id, type, avail, delivery_code, check_process_status, package_details, stores_ids, manufacturer_info, production_partner_ids, shipping_template_id, when_made, is_supply, downloadable, materials, auto_renew, on_sale, )
        ...
        return new(id, model, old_price, price, special_price, sprice_create, sprice_expire, cost_price, fixed_cost_shipping_price, retail_price, quantity, available_for_view, weight, weight_unit, dimensions_unit, increase_quantity, reduce_quantity, warehouse_id, reserve_quantity, manage_stock, backorder_status, name, sku, visible, manufacturer, manufacturer_id, categories_ids, related_products_ids, up_sell_products_ids, cross_sell_products_ids, description, short_description, meta_title, meta_keywords, meta_description, store_id, lang_id, in_stock, status, seo_url, report_request_id, disable_report_cache, reindex, tags, clear_cache, gtin, upc, mpn, ean, isbn, taxable, product_class, height, length, width, harmonized_system_code, country_of_origin, search_keywords, barcode, is_virtual, is_free_shipping, reserve_price, buyitnow_price, avail_from, tax_class_id, type, avail, delivery_code, check_process_status, package_details, stores_ids, manufacturer_info, production_partner_ids, shipping_template_id, when_made, is_supply, downloadable, materials, auto_renew, on_sale, )
    end
end # type ProductUpdate

const _property_types_ProductUpdate = Dict{Symbol,String}(Symbol("id")=>"String", Symbol("model")=>"String", Symbol("old_price")=>"Float64", Symbol("price")=>"Float64", Symbol("special_price")=>"Float64", Symbol("sprice_create")=>"String", Symbol("sprice_expire")=>"String", Symbol("cost_price")=>"Float64", Symbol("fixed_cost_shipping_price")=>"Float64", Symbol("retail_price")=>"Float64", Symbol("quantity")=>"Float64", Symbol("available_for_view")=>"Bool", Symbol("weight")=>"Float64", Symbol("weight_unit")=>"String", Symbol("dimensions_unit")=>"String", Symbol("increase_quantity")=>"Float64", Symbol("reduce_quantity")=>"Float64", Symbol("warehouse_id")=>"String", Symbol("reserve_quantity")=>"Float64", Symbol("manage_stock")=>"Bool", Symbol("backorder_status")=>"String", Symbol("name")=>"String", Symbol("sku")=>"String", Symbol("visible")=>"String", Symbol("manufacturer")=>"String", Symbol("manufacturer_id")=>"String", Symbol("categories_ids")=>"String", Symbol("related_products_ids")=>"String", Symbol("up_sell_products_ids")=>"String", Symbol("cross_sell_products_ids")=>"String", Symbol("description")=>"String", Symbol("short_description")=>"String", Symbol("meta_title")=>"String", Symbol("meta_keywords")=>"String", Symbol("meta_description")=>"String", Symbol("store_id")=>"String", Symbol("lang_id")=>"String", Symbol("in_stock")=>"Bool", Symbol("status")=>"String", Symbol("seo_url")=>"String", Symbol("report_request_id")=>"String", Symbol("disable_report_cache")=>"Bool", Symbol("reindex")=>"Bool", Symbol("tags")=>"String", Symbol("clear_cache")=>"Bool", Symbol("gtin")=>"String", Symbol("upc")=>"String", Symbol("mpn")=>"String", Symbol("ean")=>"String", Symbol("isbn")=>"String", Symbol("taxable")=>"Bool", Symbol("product_class")=>"String", Symbol("height")=>"Float64", Symbol("length")=>"Float64", Symbol("width")=>"Float64", Symbol("harmonized_system_code")=>"String", Symbol("country_of_origin")=>"String", Symbol("search_keywords")=>"String", Symbol("barcode")=>"String", Symbol("is_virtual")=>"Bool", Symbol("is_free_shipping")=>"Bool", Symbol("reserve_price")=>"Float64", Symbol("buyitnow_price")=>"Float64", Symbol("avail_from")=>"String", Symbol("tax_class_id")=>"String", Symbol("type")=>"String", Symbol("avail")=>"Bool", Symbol("delivery_code")=>"String", Symbol("check_process_status")=>"Bool", Symbol("package_details")=>"ProductAddPackageDetails", Symbol("stores_ids")=>"String", Symbol("manufacturer_info")=>"ProductAddManufacturerInfo", Symbol("production_partner_ids")=>"String", Symbol("shipping_template_id")=>"Int64", Symbol("when_made")=>"String", Symbol("is_supply")=>"Bool", Symbol("downloadable")=>"Bool", Symbol("materials")=>"Vector{String}", Symbol("auto_renew")=>"Bool", Symbol("on_sale")=>"Bool", )
