...
"""
Base.@kwdef mutable struct WebhookCreate <: OpenAPI.APIModel
    ...
    fields::Union{Nothing, String} = "force_all"
    ...
    filtering_conditions = nothing # spec type: Union{ Nothing, ParamDefinitionFilteringConditionsFilterCondition }
    idempotency_key::Union{Nothing, String} = nothing

    function WebhookCreate(entity, action, callback, label, fields, response_fields, active, lang_id, store_id, filtering_conditions, idempotency_key, )
        OpenAPI.validate_property(WebhookCreate, Symbol("entity"), entity)
        OpenAPI.validate_property(WebhookCreate, Symbol("action"), action)
        OpenAPI.validate_property(WebhookCreate, Symbol("callback"), callback)
        OpenAPI.validate_property(WebhookCreate, Symbol("label"), label)
        OpenAPI.validate_property(WebhookCreate, Symbol("fields"), fields)
        OpenAPI.validate_property(WebhookCreate, Symbol("response_fields"), response_fields)
        OpenAPI.validate_property(WebhookCreate, Symbol("active"), active)
        OpenAPI.validate_property(WebhookCreate, Symbol("lang_id"), lang_id)
        OpenAPI.validate_property(WebhookCreate, Symbol("store_id"), store_id)
        OpenAPI.validate_property(WebhookCreate, Symbol("filtering_conditions"), filtering_conditions)
        OpenAPI.validate_property(WebhookCreate, Symbol("idempotency_key"), idempotency_key)
        return new(entity, action, callback, label, fields, response_fields, active, lang_id, store_id, filtering_conditions, idempotency_key, )
    end
end # type WebhookCreate

const _property_types_WebhookCreate = Dict{Symbol,String}(Symbol("entity")=>"String", Symbol("action")=>"String", Symbol("callback")=>"String", Symbol("label")=>"String", Symbol("fields")=>"String", Symbol("response_fields")=>"String", Symbol("active")=>"Bool", Symbol("lang_id")=>"String", Symbol("store_id")=>"String", Symbol("filtering_conditions")=>"ParamDefinitionFilteringConditionsFilterCondition", Symbol("idempotency_key")=>"String", )
OpenAPI.property_type(::Type{ WebhookCreate }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_WebhookCreate[name]))}
...
function OpenAPI.validate_property(::Type{ WebhookCreate }, name::Symbol, val)
